        ...
        if (currentlocation is LivelocationLoading) {
          ...
          context.watch<DistanceAlarmStopBloc>().add(
              UpdateDistanceAlarmStopEvent(
                  ...
                  position: currentlocation.position,
                  context: context));
          context.watch<AlarmSizeBloc>().add(UpdateAlarmSizeEvent(alarmid: context.watch<AlarmNameCubit>().state.alarmid,nextStop: context.watch<NextStopBloc>().state.nextStopid,way: context.watch<WayCounterBlocCubit>().state.way);
