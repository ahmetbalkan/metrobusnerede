...
import 'package:metrobusnerede/cubit/perm_check_cubit.dart';
...
class _HomepageRightState extends State<HomepageRight> {
  ...
  Widget build(BuildContext context) {
    context.watch<PermCheckCubit>().checkPerm;
    ...
    return BlocBuilder<LivelocationBloc, LivelocationState>(
      builder: (context, currentlocation) {
        if (currentlocation is LivelocationLoading) {
          ...
          bool a = context.watch<PermCheckCubit>().state.checkperm;

          try {
            return BlocBuilder<PermCheckCubit, PermCheckState>(
              builder: (context, statelocperm) {
                print("asdasdasd " + statelocperm.checkperm.toString());
                return Column(
                  children: [
                    Row(
