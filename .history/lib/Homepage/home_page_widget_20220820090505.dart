  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: _bannerAd == null ? Container() : Container(margin: EdgeInsets.only(bottom:12),height: 52,child: AdWidget(ad: _bannerAd!)),
      ),
    );
  }
  
  void _createBannerAd() {
    _bannerAd = BannerAd(size: AdSize.fullBanner, adUnitId: AdMobService.BannerAdUnitID!, listener: AdMobService.bannerAdListener, request: const AdRequest())..load();
  }
}
